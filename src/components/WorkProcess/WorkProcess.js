  ...
  return (
    <div className='flex flex-col' id="process">
      <div className='flex flex-col justify-center items-center w-screen py-16'>
        ...
        <p className='text-sm md:text-xl lg:text-2xl text-center md:w-1/2 py-4'>Was years its season was there form he in in them together over that, third sixth gathered female creeping bearing behold years.</p>
      </div>
      <div className='flex justify-center items-center'>
        <Video />
      </div>
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-0 py-16 lg:py-16' id="services">
        {skills.map((skill) => (
