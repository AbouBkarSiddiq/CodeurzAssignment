...
export default function ContactForm() {
  return (
    <div className='flex flex-col justify-center items-center w-screen bg-gray-100 py-12 md:py-16 px-6' id="form">
      ...
      <form className='flex flex-col justify-center w-full lg:w-3/5 md:px-24 items-center'>
